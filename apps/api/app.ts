...
import dietController from "./src/entities/diet/diet.controller";
import gymController from "./src/entities/gym/gym.controller";
import recipesController from "./src/entities/recipes/recipes.controller";
